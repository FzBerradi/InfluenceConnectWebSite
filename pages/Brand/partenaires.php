<?php
session_start();
// Vérifier si l'utilisateur est une marque avant de continuer
if($_SESSION['is_brand']!= true){
  header('location:../sign-in.php');
}
// Inclure le fichier de connexion à la base de données
include('../dbconnect.php');
// Préparer une requête pour récupérer les influenceurs associés à la marque qui ont confirmé un partenariat
$listbrands=$data->prepare('SELECT * FROM user WHERE isInfluencer and id  in (select InfluencerID from partnership where BrandID=:BrandID and status="confirmed")');
$listbrands->execute([
