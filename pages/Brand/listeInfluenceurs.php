...
session_start();
// Vérifier si l'utilisateur est un annonceur, sinon rediriger vers la page de connexion
if($_SESSION['is_brand']!= true){
  header('location:../sign-in.php');
}
// Inclure le fichier de connexion à la base de données
include('../dbconnect.php');
// Récupérer les influenceurs disponibles pour un partenariat
$listbrands=$data->prepare('SELECT * FROM user WHERE isInfluencer and id  not in (select InfluencerID from partnership where BrandID=:BrandID and status ="confirmed")');
// Exécuter la requête en utilisant l'ID de l'annonceur en session
$listbrands->execute([
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./listeInfluenceurs.php">
          <div >
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">influenceurs</li>
          </ol>
        </nav>
        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Les influenceurs</h6>
              <p class="text-sm">La liste des influenceurs à contacter:</p>
            </div>
            ...
            <div class="card-body px-1 pb-0">
              ...
              <div class="brand-info">
                <ul>
                  ...
                  <li><i class="fab fa-tiktok"></i> ' . $brand['tk'] . '</li>
                  <li><i class="fab fa-facebook"></i>' . $brand['fb'] . '</li>
                  <li><i class="fab fa-instagram"></i> ' . $brand['ig'] . '</li>
                    ...
                    <button type="button"  class="contact-button"> <a href="./demandeContrat.php?id=' . $brand['ID'] . '">   <i style="color:#F9A826" class="fa fa-handshake"></i>   </a></button>
                    </div>
                  </div>
                </div>
              </div>
