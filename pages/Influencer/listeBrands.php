<?php
session_start();
// Vérification de l'authentification de l'utilisateur en tant qu'influenceur
if($_SESSION['is_influencer']!= true){
  header('location:../sign-in.php');
}
// Inclusion du fichier de connexion à la base de données
include('../dbconnect.php');
// Récupération de la liste des marques qui n'ont pas encore confirmé le partenariat
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./listeBrands.php">
          <div >
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Marques</li>
          </ol>
        </nav>
        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Marques</h6>
              <p class="text-sm">Liste des marques à contacter:</p>
            </div>
